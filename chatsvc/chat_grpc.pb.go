...
const (
	ChatService_Chat_FullMethodName = "/chatsrv.ChatService/Chat"
)
...
func (x *chatServiceChatClient) CloseAndRecv() (*FromServer, error) {
...
func (x *chatServiceChatServer) SendAndClose(m *FromServer) error {
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "chatsrv.ChatService",
